...
class LCDControl:
    ...
    def set_initial_data(self, internal_temp, external_temp):
        ...
        self.lcd.lcd_display_string('Inside temp: {} C'.format(f'{internal_temp:-9.1f}')[:20], 2)
        self.lcd.lcd_display_string('Outside temp: {} C'.format(f'{external_temp:-9.1f}')[:20], 3)
    ...
    def set_current_data(self, internal_temp, external_temp):
        ...
        self.lcd.lcd_display_string_pos(f'{internal_temp:-9.1f}', 2, 13)
        self.lcd.lcd_display_string_pos(f'{external_temp:-9.1f}', 3, 14)